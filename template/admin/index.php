        ...
        <a href="<?= url('admin/user') ?>" class="text-decoration-none">
            <div class="card text-white bg-juicy-orange mb-3">
                <div class="card-header d-flex justify-content-between align-items-center"><span><i
                    ...
                    <span class="badge badge-pill right"><?= $userCount['count'] ?></span></div>
                <div class="card-body">
                    <section class="d-flex justify-content-between align-items-center font-12">
                        ...
                        <span class=""><i class="fas fa-user"></i> All Users <span class="badge badge-pill mx-1">
                                    <?= $adminCount['count'] + $userCount['count'] ?></span></span>
                    </section>
                </div>
            </div>
        </a>
        ...
        <a href="<?= url('admin/post') ?>" class="text-decoration-none">
            <div class="card text-white bg-dracula mb-3">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <span><i class="fas fa-newspaper"></i> Article</span> <span class="badge badge-pill right">
                            <?= $postCount['count'] ?></span></div>
                <div class="card-body">
                    <section class="d-flex justify-content-between align-items-center font-12">
                            <span class=""><i class="fas fa-bolt"></i> Views <span class="badge badge-pill mx-1">
                                    <?= $postsViews['view'] == null ? 0 : $postsViews['view'] ?></span></span>
                    </section>
                </div>
            </div>
        </a>
        ...
        <a href="<?= url('admin/comment') ?>" class="text-decoration-none">
            <div class="card text-white bg-neon-life mb-3">
                <div class="card-header d-flex justify-content-between align-items-center"><span><i
                        ...
                        </span><span class="badge badge-pill right"><?= $commentCount['count'] ?></span></div>
                <div class="card-body">
                    <!--                        <h5 class="card-title">Info card title</h5>-->
                    <section class="d-flex justify-content-between align-items-center font-12">
                            <span class=""><i class="far fa-eye-slash"></i> Unseen
                                <span class="badge badge-pill mx-1"><?= $commentUnseenCount['count'] ?></span></span>
                        <span class=""><i class="far fa-check-circle"></i> Approved
                                <span class="badge badge-pill mx-1"><?= $commentApprovedCount['count'] ?></span></span>
                    </section>
                </div>
            </div>
        </a>
        ...
        <div class="table-responsive">
            <table class="table table-striped table-sm">
                ...
                <tr>
                    ...
                    <td><span class="badge badge-success"> <?=$post['commentCount']?></span></td>
                </tr>
